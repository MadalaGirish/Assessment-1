...
class Grocery(Base):
    ...
    grocery_product = "//div[@class='iyJgcM qY_4g_']"  # lists
    Add_item_grocery = "//button[text()='ADD TO BASKET']"

    def select_product_and_add_to_cart(self):
        #Grocery items
        grocery_details = self.driver.find_elements(By.XPATH, self.grocery_product)
        time.sleep(4)
    ...
    def select_grocery_product_and_add_to_cart(self):
        ...
        product_details = self.driver.find_elements(By.XPATH, self.grocery_product)
